...
Приложение автоматически ищет строку заголовков в первых 30 строках файла, поэтому Excel может содержать служебные строки над таблицей. В Excel должны быть колонки:
